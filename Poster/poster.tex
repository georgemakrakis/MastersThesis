...
\begin{center}
\Title{Molten Salt Microreactor Design Decisions}
\end{center}
\end{textblock}
...
Start design process by discussing dynamics associated with anticipated transients:
\begin{itemize*}
...
\begin{textblock}{10}(12,15)
\CHead{Pre-Filter}

\end{textblock}

\begin{textblock}{10}(24,15)
\CHead{Dead-band}
