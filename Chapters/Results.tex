...
\begin{figure}[!ht]
    \centering
    \subfloat[\centering Full-Power]{\includegraphics[width=0.49\textwidth]{Simulator/ShutDown/Control/animateTx_t/t-1}}
    \subfloat[\centering Low Power]{\includegraphics[width=0.49\textwidth]{Simulator/ShutDown/Control/animateTx_t/t-40}}
    \quad
    \subfloat[\centering Heat Exchanger at Hot-Standby]{\includegraphics[width=0.49\textwidth]{Simulator/ShutDown/Control/animateTx_t/t-60}}
    \subfloat[\centering Core at Hot-Standby]{\includegraphics[width=0.49\textwidth]{Simulator/ShutDown/Control/animateTx_t/t-120}}
...
\subsubsection{Controller Response}
The inclusion of the \acs{pi} controller makes the \acs{msnb} a viable option for demand-response profiles such as this. The set-point is tracked essentially perfectly while it is changing, and Figure \ref{fig:Demand-Power-Ctr} shows only as tiny overshoot and nearly immediate settling after both ramps. 
...
\begin{itemize}
    \item Delay Time - 1.3 min;
    \item Rise Time - 5.2 min;
    \item Settling Time - 5.5 min;
    \item Oscillation Period - 2.5 min;
    \item Inverse Response - 0.0\%;
    \item First Overshoot - 2.5\%;
    \item Second Overshoot - 0.0\%;
\end{itemize}
...
\begin{itemize}
    \item Delay Time - 1.3 min;
    \item Rise Time - 5.5 min;
    \item Settling Time - 6.1 min;
    \item Oscillation Period - 2.9 min;
    \item Inverse Response - 0.0\%;
    \item First Overshoot - 3.0\%;
    \item Second Overshoot - 0.0\%;
\end{itemize}
...
Figure \ref{fig:Demand-ControlPhase-Ctr} is a passive feedback vs. active feedback phase space representation of the transient. In comparison to Figure \ref{fig:Demand-PassivePhase-Auto}, the controller keeps the reactor much closer to unity throughout, provides tighter spirals that correspond to smaller overshoots and faster decay, and more quickly returns the \acs{msnb} to criticality after the conclusion of the transients. At the end of the simulation, the reactor is about 1.5 \textsuperscript{o}C hotter than initially, providing the -5 pcm of passive feedback where the phase space curve ends.