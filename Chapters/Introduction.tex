...
\begin{itemize}
    ...
    \item Lower pressure operating pressure lends itself to inherent safety, and less expensive components \cite{RoperReview};
...
\begin{itemize}
    \item Molten salts are very corrosive, often requiring thicker or more expensive materials \cite{RoperRedox};
